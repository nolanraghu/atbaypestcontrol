...
export const registerText = [
    ...
    new TextBox('Confirm Email Address', 'Email addresses must match', 'emailAddress', User.getEmails()[User.getEmails().length-1].updateEmail),
    new TextBox('Password', 'This field should not be empty', 'password',
        User.changePassword),
